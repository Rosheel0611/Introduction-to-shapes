...
function draw() {
  background(220);
  // TODO 3: we want the size of the shape to increase over
...
function myShape(x,y,r) {
  ...
  // You can add another variable that increases the shape
  // TODO 4: add another shape either inside the square or outside
  fill(rubyRed)
  circle(mouseX,mouseY,Ssize)
